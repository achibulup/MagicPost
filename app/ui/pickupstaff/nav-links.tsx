...
const links = [
  { name: 'Incoming', href: '/home/pickupstaff/incoming', icon: function() {return(<svg class="h-8 w-8 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    name: 'Outgoing',
    href: '/home/pickupstaff/outgoing',
