...
import { fetchEmployees, fetchOrders } from '@/lib/frontend/actions/hubmanager';
import type { OrderInfo } from '@/lib/frontend/actions/hubmanager';
...
export function EmployeeTable() {
  const columnTitles = ['Employee', 'Email', 'Phone', 'Action'];
  ...
  const redirectToEditForm = (employeeId: number) => {
    router.push(`/home/hubmanager/employees/${employeeId}/edit`);
  }
